...
void affichVoitures() {
    ...
    printf("idVoiture,marque,nom,couleur,transmission,nbplaces,prixJour,EnLocation\n");

    while (fscanf(F, "%d,%49[^,],%49[^,],%49[^,],%49[^,],%d,%d,%9[^\n]\n",
                  &v1.idVoiture, v1.marque, v1.nom, v1.couleur, v1.transmission, 
                  &v1.nbplaces, &v1.prixJour, v1.EnLocation) != EOF) {
        printf("%d,%s,%s,%s,%s,%d,%d,%s\n", v1.idVoiture, v1.marque, v1.nom, 
               v1.couleur, v1.transmission, v1.nbplaces, v1.prixJour, v1.EnLocation);
    }
